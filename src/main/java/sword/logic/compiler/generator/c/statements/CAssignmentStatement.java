...
public final class CAssignmentStatement implements CInFunctionStatement {
    private final CAssignableExpression mTarget;
    private final CExpression mExpression;

    public CAssignmentStatement(CAssignableExpression target, CExpression expression) {
